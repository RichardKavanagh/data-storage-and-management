...
cd $HOME_NEW
wget http://www-eu.apache.org/dist/cassandra/2.2.12/apache-cassandra-2.2.12-bin.tar.gz
tar -zxf apache-cassandra-2.2.12-bin.tar.gz
ln -s apache-cassandra-2.2.12 cassandra

echo 'Starting Cassandra ...'
cd $HOME_NEW/cassandra
bin/cassandra &
